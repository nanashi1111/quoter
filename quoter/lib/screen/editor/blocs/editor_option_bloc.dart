  ...
  EditorOptionBloc()
      : super(EditorOptionList(
            editorOptions: List.of([
              const EditorOption(title: "Background color", type: TYPE_SELECT_BACKGROUND_COLOR, selected: true),
          const EditorOption(title: "Background pattern", type: TYPE_SELECT_BACKGROUND_PATTERN, selected: false),

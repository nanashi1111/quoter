class QuoteData {
  ...
  static List<String> getQuotesOfCategory(String category) {
    ...
    if (category.toUpperCase().contains("LOVE")) {
      quoteList = List.from(listLoveQuote);
    } else if (category.toUpperCase().contains("FRIENDSHIP")) {
      quoteList = List.from(listFriendQuote);
    } else if (category.toUpperCase().contains("MOTIVATION")) {
      quoteList = List.from(listMotivationQuote);
    } else if (category.toUpperCase().contains("FAMILY")) {
      quoteList = List.from(listFamilyQuote);
    } else if (category.toUpperCase().contains("LIFE")) {
      quoteList = List.from(listLifeQuote);
    } else if (category.toUpperCase().contains("HAPPINESS")) {
      quoteList = List.from(listHappinessQuote);
    } else if (category.toUpperCase().contains("WOMEN")) {
      quoteList = List.from(listWomenQuote);
    } else if (category.toUpperCase().contains("MOTHER")) {
      quoteList = List.from(listMotherQuote);
    } else if (category.toUpperCase().contains("SAD")) {
      quoteList = List.from(listSadQuote);
    } else if (category.toUpperCase().contains("FATHER")) {
      quoteList = List.from(listFatherQuote);
    } else if (category.toUpperCase().contains("POSITIVE")) {
      quoteList = List.from(listPositiveQuote);
    } else if (category.toUpperCase().contains("ALONE")) {
      quoteList = List.from(listAloneQuote);
    } else if (category.toUpperCase().contains("TRUST")) {
      quoteList = List.from(listAloneQuote);
    } else if (category.toUpperCase().contains("FUNNY")) {
      quoteList = List.from(listFunnyQuote);
    }
    return quoteList ?? [];
  }

  static String getQuoteOfCategory(String category) {
    List<String>? quoteList;
    if (category.toUpperCase().contains("LOVE")) {
      quoteList = List.from(listLoveQuote);
    } else if (category.toUpperCase().contains("FRIENDSHIP")) {
  ...
  static List<String> listMotivationQuote = [
  ...
  static List<String> listFamilyQuote = [
  ...
  static List<String> listLifeQuote = ["I think being in love with life is a key to eternal youth.",
  ...
  static List<String> listHappinessQuote = ["A great obstacle to happiness is to expect too much happiness. ",
  ...
  static List<String> listWomenQuote = ["Women and cats will do as they please, and men and dogs should relax and get used to the idea.",
  ...
  static List<String> listMotherQuote = ["Mothers give up so much, so that their children can have so much. ",
  ...
  static List<String> listSadQuote = [
  ...
  static List<String> listFriendQuote = [
  ...
  static List<String> listFatherQuote = ["A father is neither an anchor to hold us back nor a sail to take us there, but a guiding light whose love shows us the way.",
  ...
  static List<String> listPositiveQuote = ["Live life to the fullest, and focus on the positive.",
  ...
  static List<String> listAloneQuote = ["I stand by myself, not because I'm lonely, but because I'm misunderstood.",
  ...
  static List<String> listTrustQuote = ["Trust but verify.",
  ...
  static List<String> listFunnyQuote = ["I used to think I was indecisive, but now I'm not too sure.",
